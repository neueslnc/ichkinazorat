            ...
            <div class="col-xl-10 mx-auto">
                ...
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        ...
                        <hr>
                        <form class="row g-3" method="post" action="{{ route('superadmin.store_update_criteria_main') }}">
                            @csrf
                            <div class="col-12">
                            ...
                            <input type="hidden" name="id" id="id" value="{{ $main_criteria->id }}">

                            <div class="col-md-12">
                                <label for="main_criteria" class="form-label">Criteria asosiy</label>
                                <input type="text" name="name" class="form-control" id="name" value="{{ $main_criteria->name }}">
